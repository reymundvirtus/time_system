        ...
        success: function(data) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                html += '<td class="align-middle text-lg">'
                    if(data[i].time_out == '00:00:00') {
                        html += '   <span class="badge badge-lg bg-gradient-success">Online</span>'
                    } else {
                        html += '   <span class="badge badge-lg bg-gradient-danger">Offline</span>'
                    }
                html += '</td>'
                html += '<td>'
                ...
                html += '</td>'
                html += '<td>'
                html += '   <div class="text-sm font-weight-bold mb-0">'
                    if(data[i].time_out == '00:00:00') {
                        html += '<div class="text-sm font-weight-bold mb-0"></div>'
                    } else {
