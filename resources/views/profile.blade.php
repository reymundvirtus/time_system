...
@section('content')
                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="../assets/img/team-3.jpg" alt="profile_image"
                        ...
                        <div class="card-header pb-0 p-3">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-end">
                                    <a href="javascript:;">
                                        <i id="edit_description" class="fas fa-user-edit text-secondary text-sm" data-bs-toggle="tooltip"
                        ...
                        <div class="card-body p-3">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item border-0 ps-0 text-sm"><strong
                                        class="text-dark">ID Code:</strong> &nbsp; {{ auth()->user()->id_code }}</li>
                                <li class="list-group-item border-0 ps-0 text-sm"><strong
    ...
    <!-- Create User Modal -->
    <div class="modal fade" id="updateUserDescription" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog" style="z-index: 99999999">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Update the Description</h5>
                </div>
                <div class="modal-body">
                    <form role="form text-left" method="POST" id="updateDescription">
                        @csrf
                        <div class="mb-3">
